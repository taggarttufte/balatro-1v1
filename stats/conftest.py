"""Test bootstrap for mp/stats: run the shared fork-guarded bootstrap so bare
``import <module>`` from mp/stats/tests/*.py resolves here and balatro_sim is the mp/engine fork."""
