"""Test bootstrap for stats: run the shared fork-guarded bootstrap so bare
``import <module>`` from stats/tests/*.py resolves here and balatro_sim is the engine fork."""
