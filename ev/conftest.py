"""Test bootstrap for mp/ev: run the shared fork-guarded bootstrap so bare
``import <module>`` from mp/ev/tests/*.py resolves here and balatro_sim is the mp/engine fork."""
