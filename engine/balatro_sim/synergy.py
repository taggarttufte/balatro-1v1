...
EARLY_GAME_JOKERS = {
    "j_green_joker", "j_space", "j_ride_the_bus", "j_square",
    "j_lucky_cat", "j_hologram", "j_vampire", "j_constellation",
    "j_fortune_teller", "j_steel_joker", "j_stone",
    "j_ice_cream", "j_popcorn", "j_gros_michel", "j_selzer",
...
SACRIFICIAL_JOKERS = {
    ...
    "j_invisible",  # sell (after 2 rounds) to duplicate a joker
}
...
JOKER_TAGS: dict[str, set[str]] = {
    ...
    "j_greedy_joker":    {"suit_diamonds"},
    "j_lusty_joker":     {"suit_hearts"},
    "j_wrathful_joker":  {"suit_spades"},
    "j_gluttenous_joker":{"suit_clubs"},
    ...
    "j_matador":        {"economy"},
    "j_satellite":      {"economy"},
    "j_mail": {"economy", "discard_synergy"},
    "j_todo_list":     {"economy"},
    "j_vagabond":       {"economy"},
    "j_trading":   {"economy", "discard_synergy"},
...
def estimate_joker_strength(joker_key: str) -> float:
    ...
    S_TIER = {"j_green_joker": 9.0, "j_space": 9.0, "j_caino": 9.0,
