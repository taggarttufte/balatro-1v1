...
class Card:
    ...
    bonus_chips: int = 0        # permanent extra chips (Hiker's perma_bonus) — W3
    face_down: bool = False     # drawn face down (The House / Wheel / Mark / Fish) — W5;
                                # hidden from the observation, revealed when played/discarded
