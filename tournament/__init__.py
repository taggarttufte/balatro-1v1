"""
mp/tournament — N-agent same-seed tournament runner + N x N outcome matrix.

Phase 3 W2 (2026-08-21).  See TOURNAMENT_NOTES.md for the interleaving contract, how lives
map, file formats and wall-clock numbers.  mp/engine/** and mp/rng/** are FROZEN for this
